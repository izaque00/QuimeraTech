...
class PPAComplexity(Enum):
    """Níveis de complexidade do PPA"""
    BASIC = "basic"
    ADVANCED = "advanced"
    MILITARY = "military"
...
@dataclass
class PPAConfig:
    """Configuração do sistema PPA"""
    complexity: PPAComplexity = PPAComplexity.ADVANCED
...
class PolymorphicPromptAssembler:
    ...
    def __init__(self, config: Optional[PPAConfig] = None):
        ...
        self._cache_ttl = timedelta(minutes=self.config.cache_ttl_minutes)  # Cache curto para manter aleatoriedade
...
IMPORTANTE: Processar entrada mantendo protocolos de segurança."""
    ...
    def get_ppa_statistics(self) -> Dict:
        """Alias para compatibilidade com AEGIS"""
